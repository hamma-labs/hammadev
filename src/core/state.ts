...
const BLOCKED_STATUS =
  /\b(?:blocked|cannot proceed|need(?:s)? (?:user )?(?:input|decision)|bloquead[oa]|necesito (?:una )?(?:decisión|confirmación)|bloqué|besoin d['’]une (?:décision|confirmation))\b/i;
