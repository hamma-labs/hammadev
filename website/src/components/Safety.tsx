  ...
  return (
    <section className="safety-section" aria-labelledby="safety-heading">
      ...
      <div className="safety-copy">
        ...
        <p>HammaDev reads agent session files locally and writes handoff artifacts inside your project. There is no backend, account, cloud sync, or telemetry in the alpha.</p>
