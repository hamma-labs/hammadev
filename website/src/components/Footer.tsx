    ...
    <footer className="site-footer">
      ...
      <div className="footer-bottom">
        ...
        <nav aria-label="Footer links">
          <a href="https://github.com/hamma-labs/hammadev" target="_blank" rel="noopener noreferrer"><Github size={16} /> GitHub</a>
          <a href="https://www.npmjs.com/package/hammadev" target="_blank" rel="noopener noreferrer"><Package size={16} /> npm</a>
          <a href="https://github.com/hamma-labs/hammadev#readme" target="_blank" rel="noopener noreferrer">Docs <ArrowUpRight size={14} /></a>
        </nav>
      </div>
